      ...
      <section>
        ...
        <tr>
            <td valign="top" style="padding-top: 0; padding-bottom: 0; padding-left: 0; padding-right: 7px; border-top: 0; border-bottom: 0: border-left: 0;">
              <a href="https://www.dryzonebasementsystems.com/" target="_blank">
                <img v-show="mobilePhoneSwitch" width="220" height="139" style="width: 220px; max-width: 220px !important; height: 139px; max-height: 139px !important; margin-top: 5px;" id="preview-image-url" src="https://cdn.treehouseinternetgroup.com/cms_images/183/dryzone-signature_logo_bar.jpg" name="preview-image-url" />
        
                <img v-show="!mobilePhoneSwitch" width="190" height="121" style="width: 190px; max-width: 190px !important; height: 121px; max-height: 121px !important; margin-top: 5px;" id="preview-image-url" src="https://cdn.treehouseinternetgroup.com/cms_images/183/dryzone-signature_logo_bar.jpg" name="preview-image-url" />
              </a>
            </td>
            ...
            "background: none; border-width: 0px; border: 0px; margin: 0; padding: 0;">
              ...
              <div v-show="!mobilePhoneSwitch">
                ...
                <tr>
                  ...
                  <td valign="top" style=
                  "vertical-align: top; color: #333333; font-size: 14px; font-family: Arial, Helvetica, sans-serif;">
                  <a href="https://www.dryzonebasementsystems.com/" target="_blank" style=
                  "color: #333333; text-decoration: none; font-weight: normal; font-size: 14px;">
                    dryzonebasementsystems.com</a>
                    &nbsp;&nbsp;
                  </td>
                </tr>
                ...
                <tr>
                  <td colspan="2" style="padding-top: 5px;">
                    <a href="https://www.facebook.com/dryzonema" target="_blank" style=
                    ...
                    <a href="https://g.page/dryzonebasementsystems?share" target="_blank"
                    style=
                    "border-width:0px; border:0px; text-decoration: none;"><img width="25"
                    height="25" style=
                    "border: none; width: 25px; max-width: 25px !important; height: 25px; max-height: 25px !important;"
